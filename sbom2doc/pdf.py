...
def generate_pdf(sbom_parser, filename, outfile):
    ...
    pdfdoc.addrow("NTIAsummary",['All package information provided?', str(packages_valid)])
    ...
    pdfdoc.addrow("NTIAsummary",['Dependency relationships provided?', str(relationships_valid)])
